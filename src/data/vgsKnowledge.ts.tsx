...
export const vgsKnowledge: KnowledgeItem[] = [
  /* ================= COMPANY / IDENTITY ================= */
  {
    ...
    answer:
      "Venza Global Services, also called VGS, is a technology-focused consulting brand delivering practical, scalable digital services. VGS supports businesses that need modern technology, automation, software, cloud infrastructure, security guidance, digital growth systems, and business transformation support.",
  },
  {
    keywords: ["vijlak", "vij lak", "vgs under", "parent company", "legal entity", "registered entity"],
    answer:
  ...
  {
    keywords: [
      "owner", "who owns", "owner of vgs", "who is the owner", "founder",
      "who founded", "who started", "ceo", "director", "leadership",
      "who runs vgs", "who is behind vgs",
    ],
    answer:
      "VGS operates under VIJLAK. For official ownership, leadership, company verification, partnership, or legal information, please contact the VGS team through the Connect VGS page.",
  },
  {
    keywords: ["mission", "vgs mission", "your mission", "vision", "vgs vision", "your vision"],
    answer:
      "VGS aims to provide reliable, scalable technology solutions that empower businesses. Its vision is to become a globally trusted technology partner for practical digital transformation.",
  },
  {
    keywords: ["location", "where are you", "where is vgs", "office", "address", "head office", "country", "based in"],
    answer:
  ...
  {
    keywords: ["global", "international", "countries", "worldwide", "overseas", "remote", "outside india"],
    answer:
  ...
  /* ================= SERVICES ================= */
  {
    keywords: ["service", "services", "what services", "what do you offer", "offerings", "solutions", "help with"],
    answer:
  ...
  {
    keywords: ["ai", "artificial intelligence", "ai solution", "ai services", "ai automation", "automation", "chatbot", "ai agent", "virtual assistant"],
    answer:
  ...
  {
    keywords: ["machine learning", "ml", "prediction", "predictive", "data model", "data science", "classification", "recommendation system"],
    answer:
      "VGS can support machine-learning projects such as data analysis, prediction models, recommendation systems, business intelligence, automation workflows, and practical AI integration. The suitable approach depends on available data and business objectives.",
  },
  {
    keywords: ["software", "software development", "custom software", "application", "web application", "dashboard", "crm", "erp", "saas", "portal", "management system"],
    answer:
  ...
  {
    keywords: ["website", "web development", "web design", "corporate website", "business website", "landing page", "ecommerce", "e-commerce", "online store", "shop website"],
    answer:
  ...
  {
    keywords: ["mobile", "mobile app", "android", "ios", "iphone app", "app development", "application development"],
    answer:
  ...
  {
    keywords: ["cloud", "cloud solution", "cloud services", "server", "hosting", "infrastructure", "migration", "deploy", "deployment", "aws", "vercel", "database"],
    answer:
  ...
  {
    keywords: ["cyber", "cyber security", "security", "website security", "hack", "hacked", "protection", "vulnerability", "security audit", "penetration test"],
    answer:
  ...
  {
    keywords: ["consulting", "it consulting", "technology consulting", "digital transformation", "business transformation", "strategy", "technology strategy", "digital strategy"],
    answer:
  ...
  {
    keywords: ["marketing", "digital marketing", "seo", "social media", "google ads", "facebook ads", "lead generation", "branding", "content marketing"],
    answer:
  ...
  {
    keywords: ["business transformation service", "digital business transformation", "workflow automation", "business process improvement"],
    answer:
      "VGS helps businesses identify manual processes, operational bottlenecks, disconnected tools, and growth limitations, then plan suitable technology, automation, software, and digital workflows.",
  },

  /* ================= PRODUCTS ================= */
  {
    keywords: ["product", "products", "vgs product", "what products", "show products", "product list"],
    answer:
      "VGS products include AI Business Automation, Business Management Platform, Cloud Infrastructure, Cyber Security Assessment, Digital Growth Toolkit, and Custom Website Package. You can explore them on the Products page.",
  },
  {
    keywords: ["ai business automation", "automation product", "automate business"],
    answer:
      "AI Business Automation is designed to reduce repetitive manual work using workflows, AI assistance, lead handling, customer communication, task routing, reporting support, and business process automation.",
  },
  {
    keywords: ["business management platform", "management platform", "business platform"],
    answer:
      "The Business Management Platform is intended for organisations that need structured workflows, business operations tracking, internal dashboards, customer management, reporting, task coordination, and process control.",
  },
  {
    keywords: ["cloud infrastructure", "cloud product", "infrastructure product"],
    answer:
      "Cloud Infrastructure support focuses on scalable hosting, deployment planning, database architecture, monitoring, performance, security, backups, and reliable technology foundations for business systems.",
  },
  {
    keywords: ["cyber security assessment", "security assessment", "security product"],
    answer:
  ...
  {
    keywords: ["digital growth toolkit", "growth toolkit", "digital toolkit"],
    answer:
      "Digital Growth Toolkit is designed to help businesses strengthen their online presence through website foundations, marketing workflows, analytics, lead-generation systems, content planning, and growth strategy.",
  },
  {
    keywords: ["custom website package", "website package", "custom website"],
    answer:
  ...
  /* ================= INDUSTRIES ================= */
  {
    keywords: ["industry", "industries", "sector", "sectors", "who do you help", "who are your clients", "business type"],
    answer:
  ...
  /* ================= PORTFOLIO ================= */
  {
    keywords: ["portfolio", "projects", "project", "case study", "case studies", "previous work", "work examples", "examples"],
    answer:
      "VGS portfolio categories include AI Business Automation, Cloud Infrastructure Migration, Corporate Website Development, Mobile Application Platform, Digital Marketing Campaign, and Cyber Security Assessment. Visit the Portfolio page for available examples.",
  },

  /* ================= GALLERY ================= */
  {
    keywords: ["gallery", "photos", "presentation", "video", "documents", "docs", "sheets", "software screenshots", "cover pages"],
    answer:
  ...
  /* ================= PROJECT PROCESS ================= */
  {
    keywords: ["how do you work", "process", "workflow", "project process", "steps", "how to start", "development process"],
    answer:
  ...
  /* ================= PRICING / TIMELINE ================= */
  {
    keywords: ["price", "pricing", "cost", "budget", "quote", "quotation", "rate", "how much", "charges"],
    answer:
  ...
  {
    keywords: ["time", "timeline", "how long", "delivery", "deadline", "when complete"],
    answer:
  ...
  /* ================= SUPPORT / MAINTENANCE ================= */
  {
    keywords: ["maintenance", "support", "after support", "after launch", "update website", "software maintenance", "technical support"],
    answer:
  ...
  {
    keywords: ["payment", "pay", "invoice", "advance", "installment", "contract", "agreement"],
    answer:
  ...
  /* ================= CONSULTATION / LEADS ================= */
  {
    keywords: ["consultation", "free consultation", "meeting", "book meeting", "book consultation", "schedule call", "talk to expert"],
    answer:
  ...
  {
    keywords: ["contact", "contact vgs", "talk to team", "human", "person", "support team", "sales", "business enquiry", "enquiry"],
    answer:
  ...
  {
    keywords: ["hire", "hire vgs", "work with vgs", "start project", "new project", "need a project", "need help"],
    answer:
  ...
  /* ================= CAREERS ================= */
  {
    keywords: ["career", "job", "jobs", "vacancy", "work for vgs", "internship", "join vgs"],
    answer:
  ...
  /* ================= PARTNERSHIPS ================= */
  {
    keywords: ["partner", "partnership", "collaboration", "reseller", "agency partner", "business partner"],
    answer:
  ...
  /* ================= MEDIA ================= */
  {
    keywords: ["media", "press", "news", "interview", "media enquiry"],
    answer:
  ...
  /* ================= PRIVACY / SAFETY ================= */
  {
    keywords: ["privacy", "data privacy", "data security", "confidential", "confidentiality", "nda", "safe"],
    answer:
  ...
  {
    keywords: ["refund", "cancel", "cancellation", "complaint", "issue", "problem", "dispute"],
    answer:
  ...
  /* ================= GREETING ================= */
  {
    ...
    answer:
      "Hello! I am Venza, the VGS virtual assistant. I can help with VGS services, products, AI, websites, software, cloud, cyber security, portfolio, consultations, and business enquiries.",
  },
];